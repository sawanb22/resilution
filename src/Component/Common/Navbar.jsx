    ...
    return (
        <nav className={style.nav + ' bg-(--dark)'}>
            <div className='sm:container mx-auto lg:px-5 xl:px-10 py-3 md:py-2 flex items-center justify-between max-sm:px-3'>
                ...
                <button className='hidden md:inline px-8 py-2 bg-(--savegreen) g_hover' onClick={() => window.open("https://discord.com/invite/KG5WKCnkWW", "_blank", "noopener,noreferrer")}>Get Started</button>
            ...
            <div className={`${style.snav} ${isopen && style.active} sm:container mx-auto md:hidden m`}>
                ...
                <div className='pt-3 pb-5 max-sm:px-3'>
                    <button className='px-8 text-sm py-2 bg-(--savegreen) g_hover' onClick={() => { setOpen(false); window.open("https://discord.com/invite/KG5WKCnkWW", "_blank", "noopener,noreferrer"); }}>Get Started</button>
                </div>
            </div>
        </nav>
    )
