...
const NewHome = () => {
    ...
    return (
        <div className="bg-black min-h-screen text-white font-['GACCO'] break-words">
            ...
            {/* ═══════════════════ HERO SECTION ═══════════════════ */}
            <Navbar />
            <section id="hero" className="relative w-full bg-black text-white overflow-hidden flex justify-center" style={{ height: '700px', marginTop: '83px' }}>
            ...
            {/* ═══════════════════ FOOTER ═══════════════════ */}
            {/* ═══════════════════ FOOTER ═══════════════════ */}
            <footer className="bg-black text-white relative mx-auto overflow-hidden" style={{ width: '1441px', height: '901px' }}>

                {/* Logo */}
                <div className="absolute left-1/2 -translate-x-1/2" style={{ top: '64px' }}>
                    <img src="/homepage_assets/resilution heading.svg" alt="Resilution" className="h-[30px]" />
                </div>

                {/* Description Text */}
                <div className="absolute text-center text-gray-300"
                    style={{
                        top: '128px',
                        left: '213px',
                        width: '1014px',
                ...
                {/* Separator Line (Top) */}
                <div className="absolute left-1/2 -translate-x-1/2 bg-gray-800" style={{ top: '240px', width: '1280px', height: '1px' }}></div>

                {/* Links Section */}
                <div className="absolute flex justify-between w-[1280px] left-1/2 -translate-x-1/2" style={{ top: '320px' }}>
                    {/* PLATFORM */}
                    <div className="flex flex-col gap-4">
                        <h4 className="text-[#C8FF80] uppercase mb-2" style={{ fontFamily: 'Arial', fontSize: '18px' }}>PLATFORM</h4>
                        <a href="#" className="text-gray-400 hover:text-white transition-colors">What's New</a>
                        ...
                        <a href="#" className="text-gray-400 hover:text-white transition-colors">Transparency</a>
                        <a href="#" className="text-gray-400 hover:text-white transition-colors">Ecosystem</a>
                        <a href="#" className="text-gray-400 hover:text-white transition-colors">All Features</a>
                    </div>
                    {/* SUPPORT */}
                    <div className="flex flex-col gap-4">
                        <h4 className="text-[#C8FF80] uppercase mb-2" style={{ fontFamily: 'Arial', fontSize: '18px' }}>SUPPORT</h4>
                        ...
                        <a href="#" className="text-gray-400 hover:text-white transition-colors">Community Support</a>
                    ...
                    {/* RESOURCES */}
                    <div className="flex flex-col gap-4">
                        <h4 className="text-[#C8FF80] uppercase mb-2" style={{ fontFamily: 'Arial', fontSize: '18px' }}>RESOURCES</h4>
                        <a href="#" className="text-gray-400 hover:text-white transition-colors">Whitepaper</a>
                        <a href="#" className="text-gray-400 hover:text-white transition-colors">Litepaper</a>
                    ...
                    {/* COMPANY */}
                    <div className="flex flex-col gap-4">
                        <h4 className="text-[#C8FF80] uppercase mb-2" style={{ fontFamily: 'Arial', fontSize: '18px' }}>COMPANY</h4>
                        <a href="#" className="text-gray-400 hover:text-white transition-colors">About Resilution</a>
                        ...
                        <a href="#" className="text-gray-400 hover:text-white transition-colors">Legal & Compliance</a>
                        <a href="#" className="text-gray-400 hover:text-white transition-colors">Privacy Policy</a>
                    </div>
                </div>

                {/* Separator Line (Bottom) */}
                <div className="absolute left-1/2 -translate-x-1/2 bg-gray-800" style={{ bottom: '100px', width: '1280px', height: '1px' }}></div>

                {/* Bottom Bar: Copyright, Socials, Credit */}
                <div className="absolute w-[1280px] left-1/2 -translate-x-1/2 flex justify-between items-center" style={{ bottom: '40px' }}>
                    <div className="text-gray-500 text-sm">
                        © 2026 Resilution. All rights reserved.
                    </div>

                    <div className="flex gap-6">
                        {/* X (Twitter) */}
                        <a href="#" className="text-white hover:text-[#C8FF80]">
                        ...
                        {/* Telegram/Plane Icon approximation */}
                        <a href="#" className="text-white hover:text-[#C8FF80]">
                    ...
                    <div className="text-gray-500 text-sm">
                        Design By spearmint technologies
                    </div>
                </div>
            </footer>
